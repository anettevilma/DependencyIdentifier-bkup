			...
			.extend(
					b.jgrid,
					{
						...
						stripHtml : function(f) {
							...
							var i = /<("[^"]*"|'[^']*'|[^'">])*>/gi;
							if (f)
								return (f = f.replace(i, "")) && f !== "&nbsp;"
										&& f !== "&#160;" ? f.replace(/\"/g,
										"'") : "";
							else
								return f
						},
						stripPref : function(f, i) {
							var h = Object.prototype.toString.call(f).slice(8,
									-1);
							if (h == "String" || h == "Number") {
								f = String(f);
								i = f != "" ? String(i).replace(String(f), "")
										: i
							}
							return i
						},
						stringToDoc : function(f) {
							...
							if (typeof f !== "string")
								return f;
							try {
								i = (new DOMParser).parseFromString(f,
										"text/xml")
							} catch (h) {
						...
						parseDate : function(f, i) {
							...
							if (i && i !== null && i !== undefined) {
								...
								for (g = f.length; c < g; c++) {
									...
									if (i[c] !== undefined)
										h[f[c].toLowerCase()] = parseInt(i[c],
												10)
								}
						...
						ajaxOptions : {},
						from : function(f) {
							return new function(i, h) {
								if (typeof i == "string")
									i = b.data(i);
								var c = this, g = i, k = true, l = false, a = h, r = /[\$,%]/g, x = null, y = null, H = 0, L = false, M = "", P = [], U = true;
								if (typeof i == "object" && i.push) {
									if (i.length > 0)
										U = typeof i[0] != "object" ? false
												: true
								} else
								...
								this._doSort = function(o, n) {
									var s = P[n].by, D = P[n].dir, T = P[n].type, J = P[n].datefmt;
									if (n == P.length - 1)
										return c._getOrder(o, s, D, T, J);
									n++;
									s = c._getGroup(o, s, D, T, J);
									D = [];
									for (T = 0; T < s.length; T++) {
										J = c._doSort(s[T].items, n);
										for ( var C = 0; C < J.length; C++)
											D.push(J[C])
									}
									return D
								};
								this._getOrder = function(o, n, s, D, T) {
									var J = [], C = [], ca = s == "a" ? 1 : -1, V, fa;
									if (D === undefined)
										D = "text";
									fa = D == "float" || D == "number"
											|| D == "currency"
											|| D == "numeric" ? function(R) {
										R = parseFloat(String(R).replace(r, ""));
										return isNaN(R) ? 0 : R
									}
											: D == "int" || D == "integer" ? function(
													R) {
									...
									C.sort(function(R, $) {
										R = R.vSort;
										$ = $.vSort;
										return c._compare(R, $, ca)
									});
									D = 0;
									for ( var oa = o.length; D < oa;) {
										s = C[D].index;
										J.push(o[s]);
										D++
									}
								...
								this._getGroup = function(o, n, s, D, T) {
									var J = [], C = null, ca = null, V;
									b.each(c._getOrder(o, n, s, D, T),
											function(fa, oa) {
												V = b.jgrid.getAccessor(oa, n);
												if (V === undefined)
													V = "";
												if (!c._equals(ca, V)) {
													ca = V;
								...
								this.andNot = function(o, n, s) {
									L = !L;
									return c.and(o, n, s)
								};
								this.orNot = function(o, n, s) {
									L = !L;
									return c.or(o, n, s)
								};
								this.not = function(o, n, s) {
									return c.andNot(o, n, s)
								};
								this.and = function(o, n, s) {
									M = " && ";
									if (o === undefined)
										return c;
									return c._repeatCommand(o, n, s)
								};
								this.or = function(o, n, s) {
									M = " || ";
									if (o === undefined)
										return c;
									return c._repeatCommand(o, n, s)
								...
								this._compareValues = function(o, n, s, D, T) {
									var J;
									J = U ? "jQuery.jgrid.getAccessor(this,'"
											+ n + "')" : "this";
									if (s === undefined)
										s = null;
									var C = s, ca = T.stype === undefined ? "text"
											: T.stype;
									if (s !== null)
										switch (ca) {
										case "int":
										case "integer":
											C = isNaN(Number(C)) || C === "" ? "0"
													: C;
											J = "parseInt(" + J + ",10)";
											C = "parseInt(" + C + ",10)";
											break;
								...
								this.equals = function(o, n, s) {
									return c._compareValues(c.equals, o, n,
											"==", s)
								};
								this.notEquals = function(o, n, s) {
									return c._compareValues(c.equals, o, n,
											"!==", s)
								};
								this.isNull = function(o, n, s) {
									return c._compareValues(c.equals, o, null,
											"===", s)
								};
								this.greater = function(o, n, s) {
									return c._compareValues(c.greater, o, n,
											">", s)
								};
								this.less = function(o, n, s) {
									return c._compareValues(c.less, o, n, "<",
											s)
								};
								this.greaterOrEquals = function(o, n, s) {
									return c._compareValues(c.greaterOrEquals,
											o, n, ">=", s)
								};
								this.lessOrEquals = function(o, n, s) {
									return c._compareValues(c.lessOrEquals, o,
											n, "<=", s)
								};
								this.startsWith = function(o, n) {
									var s = n === undefined || n === null ? o
											: n;
									s = l ? b.trim(s.toString()).length : s
											.toString().length;
									if (U)
										c
												._append(c
										...
										s = l ? b.trim(n.toString()).length : n
												.toString().length;
								...
								this.groupBy = function(o, n, s, D) {
									if (!c._hasData())
										return null;
									return c._getGroup(g, o, n, s, D)
								};
								this.orderBy = function(o, n, s, D) {
				...
				.each(function() {
					if (!this.grid) {
						var c = b.extend(true, {
							...
							dragMove : function(d) {
								if (this.resizing) {
									var e = d.clientX - this.resizing.startX;
									d = this.headers[this.resizing.idx];
									var j = c.direction === "ltr" ? d.width + e
											: d.width - e, m;
									if (j > 33) {
										this.curGbox.css({
							...
							dragEnd : function() {
								...
								if (this.resizing) {
									var d = this.resizing.idx, e = this.headers[d].newWidth
											|| this.headers[d].width;
									e = parseInt(e, 10);
									this.resizing = false;
									b("#rs_m" + b.jgrid.jqID(c.id)).css(
											"display", "none");
									c.colModel[d].width = e;
									this.headers[d].width = e;
									this.headers[d].el.style.width = e + "px";
									this.cols[d].style.width = e + "px";
									if (this.footers.length > 0)
										this.footers[d].style.width = e + "px";
									if (c.forceFit === true) {
										e = this.headers[d + c.nv].newWidth
												|| this.headers[d + c.nv].width;
										this.headers[d + c.nv].width = e;
										this.headers[d + c.nv].el.style.width = e
												+ "px";
										this.cols[d + c.nv].style.width = e
												+ "px";
										if (this.footers.length > 0)
											this.footers[d + c.nv].style.width = e
													+ "px";
										c.colModel[d + c.nv].width = e
									} else {
							...
							populateVisible : function() {
								...
								g.timer = null;
								var d = b(g.bDiv).height();
								if (d) {
									var e = b("table:first", g.bDiv), j, m;
									if (e[0].rows.length)
										try {
											m = (j = e[0].rows[1]) ? b(j)
													.outerHeight()
									...
									if (m) {
										g.prevRowHeight = m;
										var B = c.rowNum;
										j = g.scrollTop = g.bDiv.scrollTop;
										...
										if (E < d
												...
												&& (c.lastpage === undefined || parseInt(
														(E + j + m - 1) / m, 10) <= c.lastpage)) {
											z = parseInt((d - E + m - 1) / m,
													10);
											if (E >= 0 || z < 2
													|| c.scroll === true) {
												v = Math.round((E + j) / m) + 1;
												t = -1
											} else
												t = 1
										}
										if (t > 0) {
											v = parseInt(j / m, 10) + 1;
											z = parseInt((j + d) / m, 10) + 2
													- v;
											u = true
										}
										if (z)
											if (!(c.lastpage && v > c.lastpage
													|| c.lastpage == 1 || v === c.page
													&& v === c.lastpage))
												if (g.hDiv.loading)
													g.timer = setTimeout(
															g.populateVisible,
							...
							scrollGrid : function(d) {
								if (c.scroll) {
									var e = g.bDiv.scrollTop;
							...
							selectionPreserver : function(d) {
								var e = d.p, j = e.selrow, m = e.selarrrow ? b
										.makeArray(e.selarrrow) : null, p = d.grid.bDiv.scrollLeft, B = e.gridComplete;
								e.gridComplete = function() {
									e.selrow = null;
									e.selarrrow = [];
									if (e.multiselect && m && m.length > 0)
										for ( var t = 0; t < m.length; t++)
											m[t] != j
													&& b(d).jqGrid(
															"setSelection",
															m[t], false);
									j && b(d).jqGrid("setSelection", j, false);
						...
						if (this.tagName.toUpperCase() != "TABLE")
							...
							if (this.p.colNames.length !== this.p.colModel.length)
								...
								b(L).insertBefore(r).attr({
									id : "gbox_" + this.id,
									dir : l
								});
								b(r).appendTo(L).attr("id", "gview_" + this.id);
								...
								var M = function(d, e) {
									d = parseInt(d, 10);
									return isNaN(d) ? e ? e : 0 : d
								}, P = function(d, e, j, m, p, B) {
									var t = a.p.colModel[d], E = t.align, v = 'style="', z = t.classes, u = t.name, q = [];
									if (E)
										v += "text-align:" + E + ";";
									if (t.hidden === true)
										v += "display:none;";
									if (e === 0)
										v += "width: " + g.headers[d].width
												+ "px;";
									else if (t.cellattr
											&& b.isFunction(t.cellattr))
										if ((d = t.cellattr.call(a, p, j, m, t,
												B))
												&& typeof d === "string") {
											d = d.replace(/style/i, "style")
													.replace(/title/i, "title");
											if (d.indexOf("title") > -1)
												t.title = false;
											if (d.indexOf("class") > -1)
												z = undefined;
											q = d.split("style");
											if (q.length === 2) {
									...
									v += (z !== undefined ? ' class="' + z
											+ '"' : "")
											+ (t.title && j ? ' title="'
													+ b.jgrid.stripHtml(j)
													+ '"' : "");
									v += ' aria-describedby="' + a.p.id + "_"
											+ u + '"';
									return v + q[0]
								}, U = function(d) {
									return d === undefined || d === null
											...
											: a.p.autoencode ? b.jgrid
													.htmlEncode(d) : d + ""
								}, o = function(d, e, j, m, p) {
									var B = a.p.colModel[j];
									if (typeof B.formatter !== "undefined") {
										d = {
											rowId : d,
											colModel : B,
											gid : a.p.id,
										...
										e = b.isFunction(B.formatter) ? B.formatter
												.call(a, e, d, m, p)
												: b.fmatter ? b.fn
														.fmatter(B.formatter,
																e, d, m, p)
									...
									if (!e || !e.length)
										e = b.map(a.p.colModel, function(j, m) {
											return m
										});
									if (d)
										e = b.map(e, function(j) {
											return j < d ? null : j - d
										});
									return e
								}, C = function(d, e, j) {
									...
									var d = a.p.data.length, e, j, m;
									e = a.p.rownumbers === true ? 1 : 0;
									j = a.p.multiselect === true ? 1 : 0;
									m = a.p.subGrid === true ? 1 : 0;
									e = a.p.keyIndex === false
											|| a.p.loadonce === true ? a.p.localReader.id
											: a.p.colModel[a.p.keyIndex + j + m
													+ e].name;
									for (j = 0; j < d; j++) {
										m = b.jgrid.getAccessor(a.p.data[j], e);
										a.p._index[m] = j
									}
								}, V = function(d, e, j, m, p) {
									var B = new Date, t = a.p.datatype != "local"
											&& a.p.loadonce
											|| a.p.datatype == "xmlstring", E = a.p.datatype == "local" ? "local"
											: "xml";
									if (t) {
										a.p.data = [];
										a.p._index = {};
									...
									if (b.isXMLDoc(d)) {
										if (a.p.treeANode === -1 && !a.p.scroll) {
											...
											j = j > 1 ? j : 1;
										var v, z, u = 0, q, F = 0, S = 0, N = 0, K, O = [], Y, I = {}, w, A, G = [], ia = a.p.altRows === true ? " "
												+ a.p.altclass
												: "";
										a.p.xmlReader.repeatitems || (O = T(E));
										K = a.p.keyIndex === false ? a.p.xmlReader.id
												: a.p.keyIndex;
										if (O.length > 0 && !isNaN(K)) {
											if (a.p.remapColumns
										...
										E = (K + "").indexOf("[") === -1 ? O.length ? function(
												ga, aa) {
										...
										(d = b(a.p.xmlReader.root + " "
												+ a.p.xmlReader.row, d))
												|| (d = []);
										var ba = d.length, W = 0, Z = {}, ha;
										if (d && ba) {
											ha = parseInt(a.p.rowNum, 10);
											var pa = a.p.scroll ? b.jgrid
													.randId() : 1;
											if (p)
												ha *= p + 1;
											p = b
											...
											for (; W < ba;) {
												...
												if (t || a.p.treeGrid === true) {
													I._id_ = A;
													a.p.data.push(I);
													a.p._index[A] = a.p.data.length - 1
												}
												if (a.p.gridview === false) {
													b("tbody:first", e).append(
															G.join(""));
													p
															&& a.p.afterInsertRow
																	.call(a, A,
									...
									if (d) {
										...
										var v = 0, z, u, q = [], F, S = 0, N = 0, K = 0, O, Y, I = {}, w, A, G = [], ia = a.p.altRows === true ? " "
												+ a.p.altclass
												: "";
										a.p.page = b.jgrid.getAccessor(d,
												e.page) || 0;
										O = b.jgrid.getAccessor(d, e.total);
										a.p.lastpage = O === undefined ? 1 : O;
										a.p.records = b.jgrid.getAccessor(d,
												e.records) || 0;
										a.p.userData = b.jgrid.getAccessor(d,
												e.userdata)
												|| {};
										e.repeatitems || (F = q = T(t));
										t = a.p.keyIndex === false ? e.id
												: a.p.keyIndex;
										if (q.length > 0 && !isNaN(t)) {
											if (a.p.remapColumns
													&& a.p.remapColumns.length)
												t = b.inArray(t,
														a.p.remapColumns);
										...
										(Y = b.jgrid.getAccessor(d, e.root))
												|| (Y = []);
										O = Y.length;
										d = 0;
										var ba = parseInt(a.p.rowNum, 10), W = a.p.scroll ? b.jgrid
												.randId()
												: 1;
										if (p)
											ba *= p + 1;
										var Z = b
												.isFunction(a.p.afterInsertRow), ha = {}, pa = "";
										if (a.p.grouping
												&& a.p.groupingView.groupCollapse === true)
											pa = ' style="display:none;"';
										for (; d < O;) {
											p = Y[d];
											A = b.jgrid.getAccessor(p, t);
											if (A === undefined) {
												A = W + d;
												if (q.length === 0)
													if (e.cell)
											...
											for (u = 0; u < F.length; u++) {
												z = b.jgrid
														.getAccessor(p, F[u]);
												G.push(n(A, z, u + S + N + K, d
														+ j, p));
												I[a.p.colModel[u + S + N + K].name] = z
											}
											G.push("</tr>");
											if (a.p.grouping) {
												z = a.p.groupingView.groupField.length;
												u = [];
												for ( var qa = 0; qa < z; qa++)
													u
															.push(I[a.p.groupingView.groupField[qa]]);
												ha = b(a).jqGrid(
														"groupingPrepare", G,
														u, ha, I);
												G = []
											}
											if (E || a.p.treeGrid === true) {
												I._id_ = A;
												a.p.data.push(I);
												a.p._index[A] = a.p.data.length - 1
											}
											...
											try {
												(ba = w.rules.length
														&& w.groupOp.toString()
																.toUpperCase() === "OR")
														&& q.orBegin();
												for (G = 0; G < w.rules.length; G++) {
													Z = w.rules[G];
													W = w.groupOp.toString()
															.toUpperCase();
													if (u[Z.op] && Z.field) {
														if (A > 0 && W
																&& W === "OR")
									...
									var e, j = false, m = {}, p = [], B = [], t, E, v;
									if (b.isArray(a.p.data)) {
										var z = a.p.grouping ? a.p.groupingView
												: false;
										b
												.each(
														a.p.colModel,
										...
										if (a.p.treeGrid)
											b(a).jqGrid("SortTree", e,
													a.p.sortorder, m[e].stype,
													m[e].srcfmt);
										else {
											var u = {
												eq : function(w) {
											...
											if (e && a.p.sortorder && j)
												a.p.sortorder.toUpperCase() == "DESC" ? q
														...
														: q.orderBy(
																...
																m[e].srcfmt);
											F = q.select();
											var N = parseInt(a.p.rowNum, 10), K = F.length, O = parseInt(
													a.p.page, 10), Y = Math
													.ceil(K / N), I = {};
											F = F.slice((O - 1) * N, O * N);
											m = q = null;
											I[a.p.localReader.total] = Y;
											I[a.p.localReader.page] = O;
											I[a.p.localReader.records] = K;
											I[a.p.localReader.root] = F;
											I[a.p.localReader.userdata] = a.p.userData;
											F = null;
											return I
										}
									}
									...
									if (!a.grid.hDiv.loading) {
										var e = a.p.scroll && d === false, j = {}, m, p = a.p.prmNames;
										if (a.p.page <= 0)
											a.p.page = 1;
										if (p.search !== null)
								...
								x = function(d, e) {
									var j = "", m = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", p = "", B, t, E, v, z = function(
											u) {
										var q;
										if (b.isFunction(a.p.onPaging))
											q = a.p.onPaging.call(a, u);
										a.p.selrow = null;
										if (a.p.multiselect) {
											a.p.selarrrow = [];
									...
									if (a.p.rowList.length > 0) {
										...
										for (t = 0; t < a.p.rowList.length; t++)
											p += '<option role="option" value="'
													+ a.p.rowList[t]
													+ '"'
													+ (a.p.rowNum == a.p.rowList[t] ? ' selected="selected"'
															: "")
													+ ">"
													+ a.p.rowList[t]
													+ "</option>";
												...
												.click(
														function() {
															var u = M(a.p.page,
																	1), q = M(
																	a.p.lastpage,
																	1), F = false, S = true, N = true, K = true, O = true;
															if (q === 0
																	|| q === 1)
																O = K = N = S = false;
															else if (q > 1
									...
									a.p.pginput === true
											&& b("input.ui-pg-input", "#" + B)
													.keypress(
															function(u) {
																if ((u.charCode ? u.charCode
																		: u.keyCode ? u.keyCode
																				: 0) == 13) {
																	a.p.page = b(
																			this)
								...
								var Ca = function(d, e, j, m) {
									if (a.p.colModel[e].sortable)
										if (!(a.p.savedRow.length > 0)) {
											if (!j) {
												if (a.p.lastsort == e)
													...
													a.p.sortorder = a.p.colModel[e].firstsortorder
															|| "asc";
												a.p.page = 1
											}
											if (m)
											...
											a.p.sortname = a.p.colModel[e].index
													|| d;
											j = a.p.sortorder;
											if (b.isFunction(a.p.onSortCol))
												if (a.p.onSortCol.call(a, d, e,
														j) == "stop") {
													a.p.lastsort = e;
													return
												}
									...
									var e, j = {}, m = H ? 0 : a.p.cellLayout;
									for (e = j[0] = j[1] = j[2] = 0; e <= d; e++)
										if (a.p.colModel[e].hidden === false)
											j[0] += a.p.colModel[e].width + m;
									...
									var e, j = a.grid.headers, m = b.jgrid
											.getCellIndex(d);
								...
								a.p.data.length && ca();
								var da = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", Ea, ma, sa, ra, ta, X, Q, na;
								ma = na = "";
								...
								for (k = 0; k < this.p.colNames.length; k++) {
									...
									da += "<th id='"
											...
											+ l + "'" + ma + ">";
									ma = a.p.colModel[k].index
											|| a.p.colModel[k].name;
									da += "<div id='jqgh_" + a.p.id + "_"
											+ a.p.colModel[k].name + "' " + Ea
											+ ">" + a.p.colNames[k];
								...
								(function() {
									var d = 0, e = H ? 0 : a.p.cellLayout, j = 0, m, p = a.p.scrollOffset, B, t = false, E, v = 0, z = 0, u;
									b.each(a.p.colModel, function() {
										if (typeof this.hidden === "undefined")
											this.hidden = false;
										this.widthOrg = B = M(this.width, 0);
										...
										if (t) {
											if (g.width - v - (d + e * j) !== p)
												...
												&& Math.abs(g.width - v
														- (d + e * j)) !== 1)
											u = g.width - v - (d + e * j);
										a.p.colModel[m].width += u;
										a.p.tblwidth = d + u + e * j + v;
								...
								b(L).css("width", g.width + "px").append(
								...
								b("th", r)
												...
												function(d) {
													if (b(d.target)
														...
														if (a.p.forceFit === true) {
															var j = a.p, m = e, p;
															for (p = e + 1; p < a.p.colModel.length; p++)
										...
										.click(
												function(d) {
													...
													var e = "th>div.ui-jqgrid-sortable", j, m;
													a.p.viewsortcols[2]
															|| (e = "th>div>span>span.ui-grid-ico-sort");
													d = b(d.target).closest(e);
													if (d.length == 1) {
														e = Da(this);
										...
										.click(
												function(d) {
													...
													if (X.tagName == "A"
															|| (X.tagName == "INPUT"
																	|| X.tagName == "TEXTAREA"
																	|| X.tagName == "OPTION" || X.tagName == "SELECT")
															&& !e)
														return this;
													if (j === true) {
								...
								if (y) {
									...
									a.p.multikey
											&& b(g.bDiv).bind("selectstart",
													function() {
														return false
													})
								} else
									a.p.multikey
											&& b(g.bDiv).bind("mousedown",
													function() {
														return false
													});
								ea && b(g.bDiv).hide();
								...
								if (a.p.toolbar[0]) {
									...
									if (a.p.toolbar[1] == "both") {
										...
										b(g.uDiv).width(g.width).addClass(
												"ui-userdata ui-state-default")
												.attr("id", "t_" + this.id);
									ea && b(g.uDiv).hide()
								}
								if (a.p.toppager) {
									a.p.toppager = b.jgrid.jqID(a.p.id)
											+ "_toppager";
									g.topDiv = b("<div id='" + a.p.toppager
											+ "'></div>")[0];
								...
								if (a.p.footerrow) {
									...
									k = b("<div class='ui-jqgrid-hbox"
											+ (l == "rtl" ? "-rtl" : "")
											+ "'></div>");
									b(g.sDiv).append(k).insertAfter(g.hDiv)
											.width(g.width);
									b(k).append(va);
								...
								if (a.p.caption) {
									...
									if (a.p.hidegrid === true) {
										b(".ui-jqgrid-titlebar-close", g.cDiv)
												.click(
														function(d) {
															var e = b
									...
									b(g.cDiv).hide();
								b(g.hDiv).after(g.bDiv).mousemove(function(d) {
									if (g.resizing) {
										g.dragMove(d);
										return false
									}
								});
								b(".ui-jqgrid-labels", g.hDiv).bind(
								...
								a.formatCol = P;
								a.sortData = Ca;
								a.updatepager = function(d, e) {
									var j, m, p, B, t, E, v, z = "", u = a.p.pager ? "_"
									...
									z += a.p.toppager ? z ? "," + a.p.toppager
											: a.p.toppager : "";
									if (z) {
										v = b.jgrid.formatter.integer || {};
										j = M(a.p.page);
										m = M(a.p.lastpage);
										b(".selbox", z)[this.p.useProp ? "prop"
												: "attr"]("disabled", false);
										if (a.p.pginput === true) {
											b(".ui-pg-input", z).val(a.p.page);
											B = a.p.toppager ? "#sp_1" + u
													+ ",#sp_1" + q : "#sp_1"
													+ u;
											b(B)
													.html(
								...
								a.refreshIndex = ca;
								a.formatter = function(d, e, j, m, p) {
									return o(d, e, j, m, p)
								};
								b.extend(g, {
									populate : ja,
	...
	b.jgrid
			.extend({
				getGridParam : function(f) {
					var i = this[0];
					if (i && i.grid)
						return f ? typeof i.p[f] != "undefined" ? i.p[f] : null
								: i.p
				},
				...
				setSelection : function(f, i) {
					return this
							.each(function() {
								function h(a) {
									var r = b(c.grid.bDiv)[0].clientHeight, x = b(c.grid.bDiv)[0].scrollTop, y = c.rows[a].offsetTop;
									a = c.rows[a].clientHeight;
									if (y + a >= r + x)
										b(c.grid.bDiv)[0].scrollTop = y
												- (r + x) + a + x;
									else if (y < r + x)
										if (y < x)
											b(c.grid.bDiv)[0].scrollTop = y
								...
								if (f !== undefined) {
									...
									if (!(!k || k.className
										...
										if (c.p.multiselect) {
											b("#cb_" + b.jgrid.jqID(c.p.id),
													c.grid.hDiv)[c.p.useProp ? "prop"
													: "attr"]("checked", false);
											c.p.selrow = k.id;
								...
								if (typeof f !== "undefined") {
									...
									if (i.p.multiselect) {
										b("#jqg_" + b.jgrid.jqID(i.p.id) + "_"
												...
												: "attr"]("checked", false);
										b("#cb_" + b.jgrid.jqID(i.p.id))[i.p.useProp ? "prop"
												: "attr"]("checked", false)
									}
									c = null
				...
				setRowData : function(f, i, h) {
					var c, g = true, k;
					this
							.each(function() {
								if (!this.grid)
									return false;
								var l = this, a, r, x = typeof h, y = {};
								r = l.rows.namedItem(f);
								if (!r)
									return false;
								if (i)
									try {
										...
										if (l.p.datatype == "local") {
											var H = l.p._index[f];
											if (l.p.treeGrid)
												for ( var L in l.p.treeReader)
													y
															.hasOwnProperty(l.p.treeReader[L])
															&& delete y[l.p.treeReader[L]];
				...
				addRowData : function(f, i, h, c) {
					h || (h = "last");
					var g = false, k, l, a, r, x, y, H, L, M = "", P, U, o, n, s;
					if (i) {
						if (b.isArray(i)) {
							P = true;
							h = "last";
										...
										if (typeof f != "undefined")
											...
											if (this.p.keyIndex !== false) {
												U = this.p.colModel[this.p.keyIndex
														+ a + r + x].name;
												if (typeof i[0][U] != "undefined")
													f = i[0][U]
											}
										}
									o = this.p.altclass;
									for ( var T = 0, J = "", C = {}, ca = b
										...
										for (H = a + r + x; H < this.p.colModel.length; H++) {
											s = this.p.colModel[H];
											k = s.name;
											C[k] = s.formatter
													&& typeof s.formatter === "string"
													&& s.formatter == "date" ? b.unformat
													.date(n[k], s)
													: n[k];
											L = this.formatter(f, b.jgrid
													.getAccessor(n, k), H, n,
													"edit");
											M = this.formatCol(H, 1, L, n, f,
													true);
											l += '<td role="gridcell" aria-describedby="'
													+ this.p.id
													+ "_"
										...
										T++;
										if (this.p.datatype == "local") {
											C[this.p.localReader.id] = f;
											this.p._index[f] = this.p.data.length;
											this.p.data.push(C);
											C = {}
										}
									}
									if (this.p.altRows === true && !P)
										if (h == "last")
						...
						b(this.p.colModel).each(
								function(y) {
									...
									if (f == "set") {
										...
										l[g] = b("tr.footrow td:eq(" + y + ")",
												r.grid.sDiv).html()
								})
					});
					return f == "get" ? l : k
				},
				showHideCol : function(f, i) {
					return this
							.each(function() {
								var h = this, c = false, g = b.browser.webkit
										|| b.browser.safari ? 0
										: h.p.cellLayout, k;
								if (h.grid) {
									if (typeof f === "string")
										f = [ f ];
									i = i != "none" ? "" : "none";
									var l = i === "" ? true : false, a = h.p.groupHeader
											&& (typeof h.p.groupHeader === "object" || b
													.isFunction(h.p.groupHeader));
									a
											&& b(h)
													.jqGrid(
															"destroyGroupHeader",
									...
									if (c === true)
										b(h)
												.jqGrid(
														"setGridWidth",
														h.p.shrinkToFit === true ? h.p.tblwidth
																: h.p.width);
									a
											&& b(h).jqGrid("setGroupHeaders",
													h.p.groupHeader)
								}
							})
				},
				...
				remapColumns : function(f, i, h) {
					...
					function g(l, a) {
						b(">tr" + (a || ""), l).each(function() {
							var r = this, x = b.makeArray(r.cells);
							b.each(f, function() {
								var y = x[this];
								y && r.appendChild(y)
							})
				...
				setGridWidth : function(f, i) {
					return this
							.each(function() {
								if (this.grid) {
									var h = this, c, g = 0, k = b.browser.webkit
											|| b.browser.safari ? 0
											: h.p.cellLayout, l, a = 0, r = false, x = h.p.scrollOffset, y, H = 0, L = 0, M;
									if (typeof i != "boolean")
										i = h.p.shrinkToFit;
									if (!isNaN(f)) {
										f = parseInt(f, 10);
										h.grid.width = h.p.width = f;
										b("#gbox_" + b.jgrid.jqID(h.p.id)).css(
												"width", f + "px");
										b("#gview_" + b.jgrid.jqID(h.p.id))
												.css("width", f + "px");
										b(h.grid.bDiv).css("width", f + "px");
										b(h.grid.hDiv).css("width", f + "px");
										h.p.pager
												&& b(h.p.pager).css("width",
														f + "px");
										h.p.toppager
												&& b(h.p.toppager).css("width",
														f + "px");
										if (h.p.toolbar[0] === true) {
											b(h.grid.uDiv).css("width",
													f + "px");
											h.p.toolbar[1] == "both"
													&& b(h.grid.ubDiv).css(
															"width", f + "px")
										...
										if (i === true) {
											...
											y = f - k * a - H;
											if (!isNaN(h.p.height))
												if (b(h.grid.bDiv)[0].clientHeight < b(h.grid.bDiv)[0].scrollHeight
														|| h.rows.length === 1) {
													r = true;
													y -= x
												}
															...
															function(U) {
																if (this.hidden === false
																	...
																	if (!(c < 0)) {
																		this.width = c;
																		g += c;
																		h.grid.headers[U].width = c;
																		h.grid.headers[U].el.style.width = c
																				+ "px";
																		if (h.p.footerrow)
																			h.grid.footers[U].style.width = c
																					+ "px";
																		if (P)
																			h.grid.cols[U].style.width = c
																					+ "px";
																		l = U
																	}
																}
											...
											if (r) {
												if (f - H - (g + k * a) !== x)
													...
													- (g + k * a)) !== 1)
												M = f - H - (g + k * a);
											h.p.colModel[l].width += M;
											h.p.tblwidth = g + M + k * a + H;
											if (h.p.tblwidth > f) {
												r = h.p.tblwidth
														- parseInt(f, 10);
												h.p.tblwidth = f;
												...
												c = h.p.colModel[l].width;
											h.grid.headers[l].width = c;
											h.grid.headers[l].el.style.width = c
													+ "px";
											if (P)
												h.grid.cols[l].style.width = c
														+ "px";
											if (h.p.footerrow)
												h.grid.footers[l].style.width = c
														+ "px"
										}
										if (h.p.tblwidth) {
					...
					return this.each(function() {
						...
						if (this.grid)
							if (typeof f != "undefined") {
								...
								if (g >= 0) {
									var k = b("tr.ui-jqgrid-labels th:eq(" + g
											+ ")", this.grid.hDiv);
									if (i) {
										var l = b(".s-ico", k);
									...
									if (h)
										typeof h === "string" ? b(k)
												.addClass(h) : b(k).css(h);
									typeof c === "object" && b(k).attr(c)
								}
							}
					})
				},
				setCell : function(f, i, h, c, g, k) {
					return this
							.each(function() {
								var l = -1, a, r;
								if (this.grid) {
									if (isNaN(i))
										...
										l = parseInt(i, 10);
									if (l >= 0)
										if (a = this.rows.namedItem(f)) {
											var x = b("td:eq(" + l + ")", a);
											if (h !== "" || k === true) {
												a = this.formatter(f, h, l, a,
														"edit");
							...
							.each(function() {
								...
								if (this.grid) {
									if (isNaN(f))
										...
										x = parseInt(f, 10);
									if (x >= 0) {
										var y = this.rows.length, H = 0;
										if (y && y > 0) {
											for (; H < y;) {
												if (b(this.rows[H]).hasClass(
														"jqgrow")) {
													try {
														g = b
																.unformat(
																		b(this.rows[H].cells[x]),
																		{
																			rowId : this.rows[H].id,
																			colModel : this.p.colModel[x]
																		}, x)
													} catch (L) {
														g = b.jgrid
																.htmlDecode(this.rows[H].cells[x].innerHTML)
													}
													if (h) {
														r = parseFloat(g);
														k += r;
				...
				bindKeys : function(f) {
					...
					return this
							.each(function() {
								...
								h.p.scrollrows = i.scrollingRows;
								b(h)
										.keydown(
												function(c) {
													var g = b(h).find(
															"tr[tabindex=0]")[0], k, l, a, r = h.p.treeReader.expanded_field;
													if (g) {
														a = h.p._index[g.id];
														if (c.keyCode === 37
																|| c.keyCode === 38
...
(function(b) {
	...
	b.fmatter.util = {
		NumberFormat : function(a, c) {
			...
			if (b.fmatter.isNumber(a)) {
				var d = a < 0, e = a + "", f = c.decimalSeparator ? c.decimalSeparator
						: ".", g;
		...
		DateFormat : function(a, c, d, e) {
			var f = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, g = typeof c === "string" ? c
					.match(f)
					: null;
			f = function(m, r) {
				m = String(m);
			...
			if (!isNaN(c - 0) && String(a).toLowerCase() == "u")
				...
				for (j = a.length; g < j; g++) {
					...
					if (c[g])
						h[a[g].toLowerCase()] = parseInt(c[g], 10)
				}
				if (h.f)
					h.m = h.f;
			...
			var l = i.getSeconds(), o = i.getMilliseconds(), n = i.getDay(), p = i
					.getFullYear(), q = (n + 6) % 7 + 1, s = (new Date(p,
					g - 1, h) - new Date(p, 0, 1)) / 864E5, t = {
				d : f(h),
				D : k.i18n.dayNames[n],
				j : h,
				...
				I : "?",
				O : (j > 0 ? "-" : "+")
						+ f(Math.floor(Math.abs(j) / 60) * 100 + Math.abs(j)
								% 60, 4),
				P : "?",
				T : (String(i)
						.match(
	...
	b.fn.fmatter.showlink = function(a, c) {
		...
		d = d.baseLinkUrl + d.showAction + "?" + d.idName + "=" + c.rowId
				+ d.addParam;
		return b.fmatter.isString(a) || b.fmatter.isNumber(a) ? "<a " + e
	...
	b.fn.fmatter.date = function(a, c, d, e) {
		...
		b.fmatter.isUndefined(c.colModel.formatoptions)
				|| (d = b.extend({}, d, c.colModel.formatoptions));
		return !d.reformatAfterEdit && e == "edit" ? b.fn.fmatter
	...
	b.fn.fmatter.rowactions = function(a, c, d, e) {
		...
		if (!b.fmatter.isUndefined(b("#" + c)[0].p.editOptions))
			f.editOptions = b("#" + c)[0].p.editOptions;
		if (!b.fmatter.isUndefined(b("#" + c)[0].p.delOptions))
			f.delOptions = b("#" + c)[0].p.delOptions;
		e = function(h) {
		...
		switch (d) {
		case "edit":
			b("#" + c).jqGrid("editRow", a, f.keys, f.onEdit, f.onSuccess,
					f.url, f.extraparam, e, f.onError, g);
			b(
					"tr#" + a + " div.ui-inline-edit, tr#" + a
							+ " div.ui-inline-del",
					"#" + c + ".ui-jqgrid-btable:first").hide();
			...
			break;
		case "save":
			if (b("#" + c).jqGrid("saveRow", a, f.onSuccess, f.url,
					f.extraparam, e, f.onError, g)) {
				b(
						"tr#" + a + " div.ui-inline-edit, tr#" + a
								+ " div.ui-inline-del",
						"#" + c + ".ui-jqgrid-btable:first").show();
	...
	b.fn.fmatter.actions = function(a, c) {
		...
		b.fmatter.isUndefined(c.colModel.formatoptions)
				|| (d = b.extend(d, c.colModel.formatoptions));
		var e = c.rowId, f = "", g;
		if (typeof e == "undefined" || b.fmatter.isEmpty(e))
			return "";
		if (d.editformbutton) {
			...
			f = f
					...
					+ g + "><span class='ui-icon ui-icon-pencil'></span></div>"
		...
		f = f
				...
				+ g + "><span class='ui-icon ui-icon-disk'></span></div>";
		g = "onclick=jQuery.fn.fmatter.rowactions('"
				+ e
				+ "','"
				+ c.gid
		...
		f = f
				...
				+ g + "><span class='ui-icon ui-icon-cancel'></span></div>";
		return "<div style='margin-left:8px;'>" + f + "</div>"
	};
	b.unformat = function(a, c, d, e) {
		var f, g = c.colModel.formatter, h = c.colModel.formatoptions || {}, i = /([\.\*\_\'\(\)\{\}\+\?\\])/g, j = c.colModel.unformat
				|| b.fn.fmatter[g] && b.fn.fmatter[g].unformat;
		if (typeof j !== "undefined" && b.isFunction(j))
			...
			case "number":
				...
				c = h.thousandsSeparator.replace(i, "\\$1");
				f = b(a).text().replace(RegExp(c, "g"), "").replace(
						h.decimalSeparator, ".");
				break;
			case "currency":
		...
		return f !== undefined ? f : e === true ? b(a).text() : b.jgrid
				.htmlDecode(b(a).html())
	};
	b.unformat.select = function(a, c, d, e) {
		...
		if (c.value) {
			...
			if (b.fmatter.isString(f))
				for ( var h = f.split(";"), i = 0, j = 0; j < h.length; j++) {
					g = h[j].split(":");
					if (g.length > 2)
...
(function(a) {
	a.jgrid
			.extend({
				...
				setColProp : function(c, g) {
					return this
							.each(function() {
								if (this.grid)
									if (g)
										for ( var b = this.p.colModel, i = 0; i < b.length; i++)
											if (b[i].name == c) {
												a.extend(this.p.colModel[i], g);
												break
											}
							})
				},
				sortGrid : function(c, g, b) {
					return this.each(function() {
						var i = -1;
						if (this.grid) {
							if (!c)
								c = this.p.sortname;
							for ( var l = 0; l < this.p.colModel.length; l++)
								if (this.p.colModel[l].index == c
										|| this.p.colModel[l].name == c) {
									i = l;
									break
								}
							if (i != -1) {
								l = this.p.colModel[i].sortable;
								if (typeof l !== "boolean")
									l = true;
								if (typeof g !== "boolean")
									g = false;
					...
					return this
							.each(function() {
								if (this.grid) {
									...
									g.className = c.cl;
									c = this.id;
									a(g).removeClass("ui-jqgrid-btable");
									if (a(this.p.pager).parents("#gbox_" + c).length === 1) {
										a(g).insertBefore("#gbox_" + c).show();
							...
							.each(function() {
								...
								if (!this.ftoolbar) {
									var i = function() {
										...
										var o = f > 0 ? true : false;
										if (c.stringResult === true
												|| b.p.datatype == "local") {
											var k = '{"groupOp":"' + c.groupOp
													+ '","rules":[', t = 0;
											a.each(d, function(r, u) {
												if (t > 0)
													k += ",";
												k += '{"field":"' + r + '",';
												k += '"op":"' + h[r] + '",';
										...
										var q = false;
										if (a.isFunction(c.beforeSearch))
											q = c.beforeSearch.call(b);
										q || a(b).jqGrid("setGridParam", {
											search : o
										}).trigger("reloadGrid", [ {
											page : 1
										} ]);
										m && a(b).jqGrid("setGridParam", {
											url : m
										});
										a.isFunction(c.afterSearch)
												&& c.afterSearch()
									}, l = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"), p;
									a
											.each(
													b.p.colModel,
													function() {
														var d = this, f, j, e, h;
														j = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"
																+ b.p.direction
																+ "'></th>");
															...
															case "select":
																if (h = this.surl
																					...
																					.extend(
																							{
																								...
																								success : function(
																									...
																									e.dataInit !== undefined
																											&& e
																													.dataInit(a(
																															"select",
																															f)[0]);
																									e.dataEvents !== undefined
																											&& g(
																													a(
																															"select",
																															f)[0],
																	...
																	if (d.searchoptions
																		...
																		n = d.searchoptions.value;
																	else if (d.editoptions
																			&& d.editoptions.value)
																		n = d.editoptions.value;
																	if (n) {
																		h = document
																...
																break;
															case "text":
																h = e.defaultValue ? e.defaultValue
																		: "";
																a(f)
																		.append(
									...
									this.clearToolbar = function(d) {
										...
										var n = e > 0 ? true : false;
										if (c.stringResult === true
												|| b.p.datatype == "local") {
											var o = '{"groupOp":"' + c.groupOp
													+ '","rules":[', k = 0;
											a.each(f, function(q, r) {
												if (k > 0)
													o += ",";
												o += '{"field":"' + q + '",';
												o += '"op":"eq",';
											...
											a
													.each(
															...
															function(q, r) {
																b.p.postData
																		.hasOwnProperty(r)
																		&& delete b.p.postData[r]
															})
										} else
											a.extend(b.p.postData, f);
										var t;
										if (b.p.searchurl) {
											t = b.p.url;
											a(b).jqGrid("setGridParam", {
										...
										var m = false;
										if (a.isFunction(c.beforeClear))
											m = c.beforeClear.call(b);
										m || d && a(b).jqGrid("setGridParam", {
											search : n
										}).trigger("reloadGrid", [ {
											page : 1
										} ]);
										t && a(b).jqGrid("setGridParam", {
											url : t
										});
										a.isFunction(c.afterClear)
												&& c.afterClear()
									};
									this.toggleToolbar = function() {
										var d = a("tr.ui-search-toolbar",
												b.grid.hDiv);
										d.css("display") == "none" ? d.show()
												: d.hide()
									}
								}
							})
				...
				destroyGroupHeader : function(c) {
					...
					return this
							.each(function() {
								var g, b, i, l, p, d;
								b = this.grid;
								var f = a("table.ui-jqgrid-htable thead",
										b.hDiv), j = this.p.colModel;
								if (b) {
									g = a("<tr>", {
										role : "rowheader"
									...
									l = b.headers;
									b = 0;
									for (i = l.length; b < i; b++) {
										p = j[b].hidden ? "none" : "";
										p = a(l[b].el).width(l[b].width)
												.removeAttr("rowSpan").css(
														"display", p);
										g.append(p);
									...
									a(f).children("tr.ui-jqgrid-labels")
											.remove();
									a(f).prepend(g);
									c === true
				...
				setGroupHeaders : function(c) {
					...
					return this
							.each(function() {
								...
								var g = this, b, i, l = 0, p, d, f, j, e, h = g.p.colModel, n = h.length, o = g.grid.headers, k = a(
										"table.ui-jqgrid-htable", g.grid.hDiv), t = k
										.children("thead").children(
												"tr.ui-jqgrid-labels:last")
										.addClass("jqg-second-row-header");
								p = k.children("thead");
								var m, q = k.find(".jqg-first-row-header");
								if (q.html() === null)
									q = a("<tr>", {
										role : "row",
										"aria-hidden" : "true"
									...
									q.empty();
								var r, u = function(s, v) {
									for ( var w = 0, x = v.length; w < x; w++)
										if (v[w].startColumnName === s)
											return w;
									return -1
								};
								a(g).prepend(p);
								...
								for (b = 0; b < n; b++) {
									...
									a("<th>", {
										role : "gridcell"
											...
											"ui-first-th-" + g.p.direction)
											.appendTo(q);
									f.style.width = "";
									d = u(i.name, c.groupHeaders);
									if (d >= 0) {
										d = c.groupHeaders[d];
										l = d.numberOfColumns;
										e = d.titleText;
										for (d = i = 0; d < l && b + d < n; d++)
											h[b + d].hidden || i++;
										d = a("<th>", {
											colspan : String(i),
											role : "columnheader"
								...
								if (a.isFunction(g.p.resizeStop))
									m = g.p.resizeStop;
								r = h.find("tr.jqg-first-row-header");
								g.p.resizeStop = function(s, v) {
									r.find("th").eq(v).width(s);
									a.isFunction(m) && m.call(g, s, v)
								}
							})
				}
			})
			...
			.extend(
					a.jgrid,
					{
						...
						createEl : function(b, c, d, f, g) {
							...
							function j(l, n, r) {
								var p = [ "dataInit", "dataEvents", "dataUrl",
										"buildSelect", "sopt", "searchhidden",
										"defaultValue", "attr" ];
								if (typeof r != "undefined" && a.isArray(r))
									p = a.extend(p, r);
								a.each(n, function(o, s) {
									a.inArray(o, p) === -1 && a(l).attr(o, s)
								});
								n.hasOwnProperty("id")
										|| a(l).attr("id", a.jgrid.randId())
							}
							var e = "";
							switch (b) {
							case "textarea":
													...
													.extend(
															{
																...
																success : function(
																		l) {
																	var n = [], r = this.elem, p = this.vl, o = a
																			.extend(
																					{},
																					this.options), s = o.multiple === true;
																	if (typeof o.buildSelect != "undefined")
																		l = o
																				.buildSelect(l);
																	if (l = a(l)
																			.html()) {
							...
							case "custom":
								...
								try {
									if (a.isFunction(c.custom_element))
										if (m = c.custom_element.call(this, d,
												c)) {
											m = a(m).addClass("customelement")
													.attr({
														id : c.id,
														name : c.name
													});
...
(function(a) {
	...
	a.jgrid
			.extend({
								...
								if (e.grid) {
									...
									if (a("#" + D.themodal).html() !== null)
										...
										if (a.isFunction(f.onInitializeSearch))
											f.onInitializeSearch(a("#" + r));
										var s = a.extend([], e.p.colModel), N = "<a href='javascript:void(0)' id='"
												+ r
										...
										if (f.columns.length)
											...
											a
													.each(
															...
															function(u, E) {
																if (!E.label)
																	E.label = e.p.colNames[u];
																if (!n) {
																	var B = typeof E.search === "undefined" ? true
																			: E.search, m = E.hidden === true;
																	if (E.searchoptions
																			&& E.searchoptions.searchhidden === true
																			&& B
																			|| B
																			&& !m) {
																		n = true;
										...
										if (!F && j
											...
											var J = "eq";
											if (G >= 0 && s[G].searchoptions
													&& s[G].searchoptions.sopt)
												J = s[G].searchoptions.sopt[0];
										...
										if (f.tmplNames && f.tmplNames.length) {
											...
											a.each(f.tmplNames, function(u, E) {
												p += "<option value='" + u
														+ "'>" + E
														+ "</option>"
											});
										...
										o = "<table class='EditTable' style='border:0px none;margin-top:5px' id='"
												+ r
										...
										if (a.isFunction(f.onInitializeSearch))
											f.onInitializeSearch(a("#" + r));
										f.gbox = "#gbox_" + r;
										f.layer ? a.jgrid.createModal(D, y, f,
												"#gview_" + e.p.id, a("#gbox_"
														+ e.p.id)[0], "#"
														+ f.layer, {
													position : "relative"
												}) : a.jgrid.createModal(D, y,
												f, "#gview_" + e.p.id,
												a("#gbox_" + e.p.id)[0]);
										t
												&& a("#" + r + "_query")
												...
												.bind(
														...
														function() {
															...
															if (f.stringResult) {
																...
																E[f.sField] = m.rules[0].field;
																E[f.sValue] = m.rules[0].data;
																E[f.sOper] = m.rules[0].op;
																E[f.sFilter] = ""
															}
															e.p.search = true;
															a
				...
				editGridRow : function(f, b) {
					...
					return this
							.each(function() {
								...
								function r(g, l, w, q) {
									var H, C, v, K = 0, A, Q, I, U = [], M = false, aa = "", S;
									for (S = 1; S <= q; S++)
										aa += "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
									if (g != "_empty")
										M = a(l).jqGrid("getInd", g);
									a(l.p.colModel)
											.each(
													function(T) {
														H = this.name;
														...
														if (H !== "cb"
															...
															v = a(w)
																	.find(
																			"tr[rowpos="
																					...
																					+ "]");
															if (Z.rowabove) {
																Y = a("<tr><td class='contentinfo' colspan='"
																		+ q
																		* 2
																		+ "'>"
																		+ Z.rowcontent
															...
															a(
																	...
																	v[0])
																	.html(
																			typeof Z.label === "undefined" ? l.p.colNames[T]
																					: Z.label);
															a(
																	"td:eq("
																			+ (ha - 1)
									...
									if (K > 0) {
										...
										if (d[c.p.id].checkOnSubmit
												|| d[c.p.id].checkOnUpdate)
											d[c.p.id]._savedData[l.p.id + "_id"] = g
									}
									return U
								}
								function x(g, l, w) {
														...
														function() {
															...
															if ((v = a(
																...
																if (K.defaultValue) {
																	...
																	if (v[0].type == "checkbox") {
																		...
																		if (Q
																				...
																				&& Q !== "") {
																			v[0].checked = true;
																			v[0].defaultChecked = true;
																			v[0].value = A
																		} else {
																			v[0].checked = false;
																			v[0].defaultChecked = false
																		}
																	} else
																		v
																				.val(A)
																} else if (v[0].type == "checkbox") {
																	v[0].checked = false;
																	v[0].defaultChecked = false;
																	A = a(v)
																			.attr(
																...
																if (d[c.p.id].checkOnSubmit === true
																		|| d[c.p.id].checkOnUpdate)
																	d[c.p.id]._savedData[q] = A
															}
														});
										a("#id_g", "#" + w).val(g)
									} else {
										var U = a(l).jqGrid("getInd", g, true);
										if (U) {
											a("td", U)
													.each(
															function(M) {
																...
																if (q !== "cb"
																	...
																	case "select":
																		...
																		a(
																				...
																				.each(
																						function() {
																							this.selected = !I[M].editoptions.multiple
																									&& (a
																											.trim(C) == a
																											.trim(a(
																													this)
																	...
																	case "checkbox":
																		C += "";
																		if (I[M].editoptions
																				&& I[M].editoptions.value)
																			if (I[M].editoptions.value
																					.split(":")[0] == C) {
																				a(
																						"#"
																								+ q,
																	...
																	case "custom":
																		try {
																			if (I[M].editoptions
																					&& a
																							.isFunction(I[M].editoptions.custom_value))
																				I[M].editoptions
																						.custom_value(
																								a(
																										"#"
								...
								function D() {
									var g, l = [ true, "", "" ], w = {}, q = c.p.prmNames, H, C, v, K;
									if (a
									...
									if (l[0]) {
										if (a
											...
											w = d[c.p.id].onclickSubmit(
													d[c.p.id], h)
													|| {};
										if (a
												.isFunction(d[c.p.id].beforeSubmit))
											l = d[c.p.id].beforeSubmit(h, a("#"
													+ p))
									}
									if (l[0] && !d[c.p.id].processing) {
										d[c.p.id].processing = true;
										a("#sData", "#" + j + "_2").addClass(
												"ui-state-active");
										C = q.oper;
										H = q.id;
										h[C] = a.trim(h[c.p.id + "_id"]) == "_empty" ? q.addoper
												: q.editoper;
										if (h[C] != q.addoper)
											h[H] = h[c.p.id + "_id"];
											...
											h[H] = h[c.p.id + "_id"];
										delete h[c.p.id + "_id"];
										h = a.extend(h, d[c.p.id].editData, w);
										if (c.p.treeGrid === true) {
											if (h[C] == q.addoper) {
												K = a(c).jqGrid("getGridParam",
														"selrow");
												h[c.p.treeGridModel == "adjacency" ? c.p.treeReader.parent_id_field
														: "parent_id"] = K
											}
											for (i in c.p.treeReader) {
												w = c.p.treeReader[i];
										...
										h[H] = a.jgrid.stripPref(c.p.idPrefix,
												h[H]);
										w = a
												.extend(
														{
																...
																if (l[0] === false) {
																	...
																	if (d[c.p.id].checkOnSubmit
																		...
																		if (d[c.p.id]._savedData[c.p.id
																				+ "_id"] != "_empty")
																			for ( var U in d[c.p.id]._savedData)
																				if (h[U])
																					d[c.p.id]._savedData[U] = h[U]
																	}
																}
										...
										if (!w.url && !d[c.p.id].useDataProxy)
								...
								function y() {
									a
											.each(
													...
													function(g, l) {
														if (l.editoptions
																&& l.editoptions.NullIfEmpty === true)
															if (h
								...
								function o() {
									...
									if (d[c.p.id].checkOnUpdate) {
										...
										e();
										O = a.extend({}, h, P);
										if (V = F(O, d[c.p.id]._savedData)) {
											a("#" + p).data("disabled", true);
											a(".confirm", "#" + n.themodal)
													.show();
											g = false
										}
									}
								...
								function N() {
									var g = a(c).jqGrid("getDataIDs"), l = a(
											"#id_g", "#" + j).val();
									return [ a.inArray(l, g), g ]
								}
								var c = this;
								if (c.grid && f) {
									var t = c.p.id, p = "FrmGrid_" + t, j = "TblGrid_"
											+ t, n = {
										themodal : "editmod" + t,
										modalhead : "edithd" + t,
									...
									if (a("#" + n.themodal).html() !== null) {
										...
										if (a("#" + p).data("disabled") === true) {
											a(".confirm", "#" + n.themodal)
													.hide();
											a("#" + p).data("disabled", false)
										}
										G && G(a("#" + p));
										a("#" + n.themodal).data("onClose",
												d[c.p.id].onClose);
										...
										var ba = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"
												...
												+ b.bCancel + "</a>";
										B = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"
												+ j
												+ "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"
												+ (u ? X + B : B + X)
												+ "</td><td class='EditButton'>"
												+ ba + $ + "</td></tr>";
										B += "<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"
												+ d[c.p.id].bottominfo
												+ "</td></tr>";
										B += "</tbody></table>";
										if (z > 0) {
											...
											a.each(ca, function(g, l) {
												da.html += l
											});
											a("tbody", W).append(da.html)
										}
										b.gbox = "#gbox_" + t;
										var fa = false;
										...
										L = a("<span></span>").append(L)
												.append(B);
										a.jgrid.createModal(n, L, b, "#gview_"
												+ c.p.id,
												a("#gbox_" + c.p.id)[0]);
										if (u) {
											a("#pData, #nData", "#" + j + "_2")
										...
										if (d[c.p.id].checkOnSubmit
												|| d[c.p.id].checkOnUpdate) {
											ba = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
													+ b.bYes + "</a>";
											X = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
													+ b.bNo + "</a>";
				...
				viewGridRow : function(f, b) {
					...
					return this
							.each(function() {
								...
								function r(m, z, h, P) {
									for ( var O, V, R, L = 0, W, X, ba = [], $ = false, ca = "<td class='CaptionTD form-view-label ui-widget-content' width='"
											+ b.labelswidth
											+ "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", da = "", fa = [
											"integer", "number", "currency" ], g = 0, l = 0, w, q, H, C = 1; C <= P; C++)
										da += C == 1 ? ca
													...
													function(v) {
														...
														X = (V = this.editrules
																...
																: this.hidden === true ? true
																		: false) ? "style='display:none'"
																: "";
														H = typeof this.viewable != "boolean" ? true
																: this.viewable;
														if (O !== "cb"
																&& O !== "subgrid"
																&& O !== "rn"
															...
															var K = a
																	...
																	10);
															if (K.rowabove) {
																var I = a("<tr><td class='contentinfo' colspan='"
																		+ P
																		* 2
																		+ "'>"
																		+ K.rowcontent
															...
															a(
																	...
																	.html(
																			"<b>"
																					+ (typeof K.label === "undefined" ? z.p.colNames[v]
																							: K.label)
																					+ "</b>");
															a(
																	"td:eq("
								...
								function x(m, z) {
									var h, P, O = 0, V, R;
									if (R = a(z).jqGrid("getInd", m, true)) {
										a("td", R)
												.each(
														function(L) {
															h = z.p.colModel[L].name;
															P = z.p.colModel[L].editrules
																	&& z.p.colModel[L].editrules.edithidden === true ? false
																	: z.p.colModel[L].hidden === true ? true
																			: false;
															if (h !== "cb"
																	&& h !== "subgrid"
																	&& h !== "rn") {
																V = h == z.p.ExpandColumn
																		&& z.p.treeGrid === true ? a(
																		this)
																		.text()
																		: a(
								...
								function F() {
									var m = a(y).jqGrid("getDataIDs"), z = a(
											"#id_g", "#" + s).val();
									return [ a.inArray(z, m), m ]
								}
								var y = this;
								if (y.grid && f) {
									var o = y.p.id, k = "ViewGrid_" + o, s = "ViewTbl_"
											+ o, N = {
										themodal : "viewmod" + o,
										modalhead : "viewhd" + o,
										modalcontent : "viewcnt" + o,
										scrollelm : k
									}, c = a.isFunction(b.beforeInitData) ? b.beforeInitData
											: false, t = true, p = 1, j = 0;
									if (a("#" + N.themodal).html() !== null) {
										if (c) {
											t = c(a("#" + k));
										...
										var n = isNaN(b.dataheight) ? b.dataheight
												: b.dataheight + "px";
										...
										n = a("<span></span>")
												...
												.append(
														"<table border='0' class='EditTable' id='"
																...
																+ u
																+ "</td></tr></tbody></table>");
										a.jgrid.createModal(N, n, b, "#gview_"
												+ y.p.id,
												a("#gview_" + y.p.id)[0]);
										if (c) {
											a("#pData, #nData", "#" + s + "_2")
								...
								if (e.grid)
									if (f) {
										var r = a
												...
												.isFunction(d[e.p.id].afterShowForm), D = a
												.isFunction(d[e.p.id].beforeInitData) ? d[e.p.id].beforeInitData
												: false, F = e.p.id, y = {}, o = true, k = "DelTbl_"
												+ F, s, N, c, t, p = {
											themodal : "delmod" + F,
											modalhead : "delhd" + F,
											modalcontent : "delcnt" + F,
											scrollelm : k
										};
										if (jQuery.isArray(f))
											f = f.join();
										if (a("#" + p.themodal).html() !== null) {
											...
											var j = isNaN(d[e.p.id].dataheight) ? d[e.p.id].dataheight
													: d[e.p.id].dataheight
															+ "px";
											j = "<div id='"
													+ k
											...
											j += "<tr id='DelData' style='display:none'><td >"
													+ f + "</td></tr>";
				...
				navGrid : function(f, b, e, r, x, D, F) {
					b = a.extend({
						edit : true,
							...
							.each(function() {
								if (!this.nav) {
									...
									if (!(!o.grid || typeof f != "string")) {
										...
										var s = 1;
										if (b.cloneToTop && o.p.toppager)
											s = 2;
										for ( var N = 0; N < s; N++) {
											var c = a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"), t, p;
											if (N === 0) {
												t = f;
												p = o.p.id;
												if (t == o.p.toppager) {
					...
					return this
							.each(function() {
								if (this.grid) {
									...
									if (e) {
										var r = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='"
												+ b.sepclass
												+ "'></span>"
												+ b.sepcontent + "</td>";
										a("tr", e).append(r)
				...
				FormToGrid : function(f, b, e, r) {
					return this.each(function() {
						if (this.grid) {
							e || (e = "set");
							r || (r = "first");
							var x = a(b).serializeArray(), D = {};
							a.each(x, function(F, y) {
								D[y.name] = y.value
							});
							if (e == "add")
								a(this).jqGrid("addRowData", f, D, r);
							else
								e == "set"
										&& a(this).jqGrid("setRowData", f, D)
						}
					})
				}
			})
...
(function(a) {
	a.jgrid
			.extend({
				editRow : function(g, x, m, s, u, y, v, l, t) {
					var h = {
						keys : x || false,
						oneditfunc : m || null,
						successfunc : s || null,
					...
					b = o[0] && typeof o[0] == "object" && !a.isFunction(o[0]) ? a
							.extend(h, o[0])
							: h;
					return this
							.each(function() {
								var d = this, c, j, q = 0, r = null, p = {}, k, e;
								if (d.grid) {
									k = a(d).jqGrid("getInd", g, true);
									if (k !== false)
										if ((a(k).attr("editable") || "0") == "0"
												&& !a(k).hasClass(
														"not-editable-row")) {
											e = d.p.colModel;
											a("td", k)
																		...
																		A ? a(
																				...
																				: a(
																						...
																						.append(
																								i);
																		e[f].edittype == "select"
																				&& typeof e[f].editoptions !== "undefined"
																				&& e[f].editoptions.multiple === true
																				&& typeof e[f].editoptions.dataUrl === "undefined"
																				&& a.browser.msie
																				&& a(
																						i)
																						.width(
				...
				saveRow : function(g, x, m, s, u, y, v) {
					var l = {
						successfunc : x || null,
						url : m || null,
						extraparam : s || {},
					...
					h = t[0] && typeof t[0] == "object" && !a.isFunction(t[0]) ? a
							.extend(l, t[0])
							: l;
					var o = false, b = this[0], d, c = {}, j = {}, q = {}, r, p, k;
					if (!b.grid)
						return o;
					k = a(b).jqGrid("getInd", g, true);
					if (k === false)
						return o;
					l = a(k).attr("editable");
					h.url = h.url ? h.url : b.p.editurl;
					if (l === "1") {
						var e;
						a("td", k)
								.each(
											...
											if (d != "cb"
												...
												case "custom":
													try {
														if (e.editoptions
																&& a
																		.isFunction(e.editoptions.custom_value)) {
															c[d] = e.editoptions.custom_value
																	.call(
																			b,
																			a(
																					".customelement",
												...
												if (b.p.autoencode)
													c[d] = a.jgrid
															.htmlEncode(c[d]);
												if (h.url !== "clientArray"
														&& e.editoptions
														&& e.editoptions.NullIfEmpty === true)
													if (c[d] == "")
														q[d] = "null"
											}
										});
						if (p[0] === false) {
							try {
								var f = a.jgrid.findPos(a(
										"#" + a.jgrid.jqID(g), b.grid.bDiv)[0]);
						...
						if (c) {
							c[t] = l.editoper;
							c[f] = g;
							if (typeof b.p.inlineData == "undefined")
								b.p.inlineData = {};
							c = a.extend({}, c, b.p.inlineData, h.extraparam)
						}
						if (h.url == "clientArray") {
							c = a.extend({}, c, j);
							...
							f = a(b).jqGrid("setRowData", g, c);
							a(k).attr("editable", "0");
							for (l = 0; l < b.p.savedRow.length; l++)
								if (b.p.savedRow[l].id == g) {
									r = l;
									break
								}
							r >= 0 && b.p.savedRow.splice(r, 1);
							a.isFunction(h.aftersavefunc)
									&& h.aftersavefunc.call(b, g, f);
							o = true;
							a(k).unbind("keydown")
						} else {
							a("#lui_" + b.p.id).show();
							q = a.extend({}, c, q);
							q[f] = a.jgrid.stripPref(b.p.idPrefix, q[f]);
							a
									.ajax(a
											.extend(
													{
														url : h.url,
														data : a
																.isFunction(b.p.serializeRowData) ? b.p.serializeRowData
																.call(b, q)
																: q,
														type : h.mtype,
														async : false,
														complete : function(n,
															...
															if (i === "success")
																if ((a
																		.isFunction(h.successfunc) ? h.successfunc
																		.call(
																				b,
																				n)
																		: true) === true) {
																	...
																	a(k)
																			.attr(
																					"editable",
																					"0");
																	for ( var w = 0; w < b.p.savedRow.length; w++)
																		if (b.p.savedRow[w].id == g) {
																			r = w;
																			break
																		}
																	r >= 0
				...
				restoreRow : function(g, x) {
					return this
							.each(function() {
								var m = this, s, u, y = {};
								if (m.grid) {
									u = a(m).jqGrid("getInd", g, true);
									if (u !== false) {
										for ( var v = 0; v < m.p.savedRow.length; v++)
											if (m.p.savedRow[v].id == g) {
												s = v;
												break
											}
										if (s >= 0) {
													...
													.each(
															...
															function() {
																if (this.editable === true
																		&& this.name in m.p.savedRow[s]
																		&& !a(
																				this)
																				.hasClass(
																						"not-editable-cell"))
																	y[this.name] = m.p.savedRow[s][this.name]
															});
											a(m).jqGrid("setRowData", g, y);
											a(u).attr("editable", "0").unbind(
													"keydown");
											m.p.savedRow.splice(s, 1)
										}
										a.isFunction(x) && x.call(m, g)
									}
								}
							})
				}
	...
	b.jgrid
			.extend({
				...
				addSubGridCell : function(f, d) {
					...
					return '<td role="grid" aria-describedby="'
							+ s
			...
			.extend({
				...
				columnChooser : function(b) {
					...
					if (!a("#colchooser_" + c[0].p.id).length) {
						...
						var h = c.jqGrid("getGridParam", "colModel"), j = c
